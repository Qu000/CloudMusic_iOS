...
- (void)initDatas {
    _topViewColor = [UIColor colorWithHexString:@"FFFFFF"];
    _buttonTitleColor = [UIColor colorWithHexString:@"000000"];
}
...
//    topView = [[UIView alloc]initWithFrame:CGRectMake(0, kTimeBroadcastViewHeight-kTopViewHeight, kScreen_Width, kTopViewHeight)];
//    topView.backgroundColor = _topViewColor;
//     [self addSubview:topView];
    
    okBtn = [[UIButton alloc]initWithFrame:CGRectMake(kScreen_Width-kScreen_Width/2, kScreen_Height-kTopViewHeight, kScreen_Width/2, kTopViewHeight)];
    [okBtn setTitleColor:_buttonTitleColor forState:UIControlStateNormal];
    okBtn.titleLabel.font = [UIFont systemFontOfSize:14];
    [okBtn setBackgroundColor:[UIColor colorWithHexString:@"fcb923"]];
    [okBtn setTitle:@"确认" forState:UIControlStateNormal];
    [okBtn addTarget:self action:@selector(selectedButtons:) forControlEvents:UIControlEventTouchUpInside];
    okBtn.tag = kOKBtnTag;
//    [self addSubview:okBtn];
    
    cancleBtn = [[UIButton alloc]initWithFrame:CGRectMake(0,  kScreen_Height-kTopViewHeight, kScreen_Width/2, kTopViewHeight)];
    cancleBtn.titleLabel.font = [UIFont systemFontOfSize:14];
    [cancleBtn setTitleColor:_buttonTitleColor forState:UIControlStateNormal];
    [cancleBtn setBackgroundColor:[UIColor colorWithHexString:@"f1f1f1"]];
...
//    [self addSubview:titleLbl];
    ...
    UIView *beforeSepLine = [[UIView alloc] initWithFrame:CGRectMake(0, 0 + (kTimeBroadcastViewHeight / 5), kScreen_Width, 1.5)];
    [beforeSepLine setBackgroundColor:[UIColor colorWithHexString:@"0xEDEDED"]];
    [timeBroadcastView addSubview:beforeSepLine];
    UIView *middleSepView = [[UIView alloc] initWithFrame:CGRectMake(0, 0 + 2 * (kTimeBroadcastViewHeight / 5), kScreen_Width, kTimeBroadcastViewHeight / 5)];
    ...
    UIView *bottomSepLine = [[UIView alloc] initWithFrame:CGRectMake(0, 0 + 4 * (kTimeBroadcastViewHeight / 5), kScreen_Width, 1.5)];
...
- (void)setYearScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        yearScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width*0.28, kTimeBroadcastViewHeight)];
    }
...
- (void)setMonthScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        monthScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.28, 0, kScreen_Width*0.18, kTimeBroadcastViewHeight)];
    }
...
- (void)setDayScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        dayScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.46, 0, kScreen_Width*0.18, kTimeBroadcastViewHeight)];
    }
...
- (void)setHourScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        hourScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width*0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        hourScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.64, 0, kScreen_Width*0.18, kTimeBroadcastViewHeight)];
    }
...
- (void)setMinuteScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        minuteScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.5, 0, kScreen_Width*0.5, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerDateHourMinuteMode) {
        minuteScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.82, 0, kScreen_Width*0.18, kTimeBroadcastViewHeight)];
    }
...
- (UIView *)pageAtIndex:(NSInteger)index andScrollView:(MXSCycleScrollView *)scrollView
{
    ...
    {
        if (index < 10) {
            l.text = [NSString stringWithFormat:@"0%ld点",(long)index];
        }
        else
            l.text = [NSString stringWithFormat:@"%ld点",(long)index];
    }
    else if (scrollView == minuteScrollView)
    {
        if (index < 10) {
...
-(void)dismissBlock:(DatePickerCompleteAnimationBlock)block{
    ...
    [UIView animateWithDuration:0 delay:0 usingSpringWithDamping:0.8f initialSpringVelocity:0 options:UIViewAnimationOptionLayoutSubviews animations:^{
