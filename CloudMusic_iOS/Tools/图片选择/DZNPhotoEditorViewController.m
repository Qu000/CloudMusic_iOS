...
- (DZNPhotoEditorContainerView *)bottomView
{
    if (!_bottomView)
    {
        ...
        _bottomView.frame = CGRectMake(0, SCREEN_HEIGHT-88, SCREEN_WIDTH, 88);
//        _bottomView.translatesAutoresizingMaskIntoConstraints = NO;
        ...
        _rightButton = [self buttonWithTitle:NSLocalizedString(@"选择", nil)];
        [_rightButton addTarget:self action:@selector(acceptEdition:) forControlEvents:UIControlEventTouchUpInside];
        _leftButton.frame = CGRectMake(13, 0, 37, 88);
        _rightButton.frame = CGRectMake(SCREEN_WIDTH-50, 0, 37, 88);
